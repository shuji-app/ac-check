...
function SessionView({
  ...
  const [selectedBuildings, setSelectedBuildings] = useState([]); // 選択中の建物
  // 対象階（前回引き継ぎ、なければ全階選択）
  ...
  // 部屋リストも建物選択で絞り込む
  const filteredDevList = selectedBuildings.length > 0 && buildingKey ? devList.filter(d => selectedBuildings.includes(d._raw?.[buildingKey])) : devList;
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
            ...
            background: "linear-gradient(135deg," + C.navy + "," + C.blue + ")",
            color: C.white,
            boxShadow: "0 2px 8px rgba(37,99,176,0.4)"
          },
          children: "1"
        }, void 0, false), /*#__PURE__*/_jsxDEV("span", {
          style: {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: ["⚠️ 機器リストCSVが読み込まれていません。", /*#__PURE__*/_jsxDEV("br", {}, void 0, false), "設定画面から機器リストCSVを読み込むと、エリアの選択・入室可否チェックが利用できます。"]
      }, void 0, true)]
    }, void 0, true) : /*#__PURE__*/_jsxDEV("div", {
      style: {
        background: C.white,
      ...
      }, void 0, false), allBuildings.length > 0 && /*#__PURE__*/_jsxDEV("div", {
        style: {
          marginBottom: 8
        },
        children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: flRooms.map(r => {
                ...
                return /*#__PURE__*/_jsxDEV("div", {
                  ...
                  children: [/*#__PURE__*/_jsxDEV("div", {
                    ...
                    children: [/*#__PURE__*/_jsxDEV("div", {
                      ...
                      children: [(() => {
                        ...
                        const devItem = devList.find(d => d.floor === r.floor && d.room === r.room);
                        if (cols) {
                          return cols.map(col => {
                            ...
                            return val ? /*#__PURE__*/_jsxDEV("span", {
                              style: {
                                fontSize: 12,
                      ...
                      })(), isNG && !open && /*#__PURE__*/_jsxDEV("span", {
                        style: {
                          fontSize: 10,
                          color: C.red,
                          fontWeight: 600,
                        ...
                        children: ["🚫 ", [["today", "本日のみNG"], ["am", "午前のみNG"], ["pm", "午後のみNG"], ["discharge", "退院までNG"]].find(([v]) => v === ngType)?.[1] || "本日のみNG", memo && "　" + memo]
                      }, void 0, true)]
                    }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
                      style: {
                        display: "flex",
                  ...
                  }, void 0, true), isNG && open && /*#__PURE__*/_jsxDEV("div", {
                    style: {
                      padding: "8px 10px",
                    ...
                    children: [/*#__PURE__*/_jsxDEV("div", {
                      ...
                      children: [["today", "本日のみNG"], ["am", "午前のみNG"], ["pm", "午後のみNG"], ["discharge", "退院までNG"]].map(([v, label]) => /*#__PURE__*/_jsxDEV("button", {
                        onClick: () => {
                          setAcc(k, {
                            ngType: v
                          });
      ...
      children: !date || !inspector ? "点検日・点検者を入力してください" : visibleFloors.length > 0 && targetFloors.length === 0 ? "対象エリアを選択してください" : visibleFloors.length > 0 ? "✅ 点検を開始する（" + targetFloors.slice().sort().join("・") + ")" : "✅ 点検を開始する"
    }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
      style: {
        height: 4
      }
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        }, void 0, true), allFloorsResolved.length > 0 && (() => {
          ...
          return /*#__PURE__*/_jsxDEV(_Fragment, {
            children: [showBuildings.length > 0 && /*#__PURE__*/_jsxDEV("div", {
              style: {
                display: "flex",
                background: C.g200,
                gap: "1px"
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                children: [showBuildings.map(b => /*#__PURE__*/_jsxDEV("span", {
                  style: {
                    fontSize: 13,
                    fontWeight: 700,
                    color: C.navy,
                  ...
                  children: b
                }, b, false)), /*#__PURE__*/_jsxDEV("button", {
                  onMouseDown: e => e.preventDefault(),
                  onClick: () => setStep(0),
                  style: {
                    marginLeft: "auto",
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                children: [[...displayFloors].sort((a, b) => b.localeCompare(a, undefined, {
                  numeric: true
                })).map(fl => /*#__PURE__*/_jsxDEV("span", {
                  style: {
                    fontSize: 13,
                    fontWeight: 700,
                    color: C.blue,
                  ...
                  children: fl
                }, fl, false)), showBuildings.length === 0 && /*#__PURE__*/_jsxDEV("button", {
                  onMouseDown: e => e.preventDefault(),
                  onClick: () => setStep(0),
                  style: {
                    marginLeft: "auto",
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [false && null, devList.length > 0 ? /*#__PURE__*/_jsxDEV(_Fragment, {
              children: [/*#__PURE__*/_jsxDEV("div", {
                style: {
                  display: "flex",
                  gap: 8,
...
export default function App() {
  ...
  const [step, setStep] = useState(0); // 0=入室可否チェック 1=機器選択 2=測定データ
  ...
  const [devColumns, setDevColumns] = useState([]); // CSVの全列名
  const [devVisibleCols, setDevVisibleCols] = useState([]); // 表示する列名（空=全列）
  ...
  const filteredRows = (() => {
    ...
    return [...rows].sort((a, b) => {
      // _rawから値を取得（建物など拡張列も対応）
      const getVal = row => {
        if (row._raw && row._raw[sortCol] !== undefined) return String(row._raw[sortCol] || "");
        if (sortCol === "階") return row.floor || "";
        if (sortCol === "部屋名") return row.room || "";
        if (sortCol === "管理番号") return row.managementNo || "";
        if (sortCol === "機器番号") return row.unitNo || "";
        if (sortCol === "状態") return row.record && Object.values(row.record.values).some(v => v !== "") ? "入力済" : "未入力";
        if (sortCol === "点検日") return row.record?.inspectionDate || "";
        if (sortCol === "点検者") return row.record?.inspector || "";
        return "";
      };
      const va = getVal(a),
        vb = getVal(b);
    ...
    children: [/*#__PURE__*/_jsxDEV("style", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("button", {
          ...
          children: "💾 CSV"
        }, void 0, false), [["form", "📝 点検データ入力"], ["list", "📋 一覧" + (records.length > 0 ? " (" + records.length + ")" : "")], ["settings", "⚙️ 設定"]].map(([v, label]) => /*#__PURE__*/_jsxDEV("button", {
          onClick: () => {
            setView(v);
            if (v === "form" && editIdx === null) setStep(0);
          },
          style: {
            padding: "6px 12px",
            borderRadius: 7,
      ...
      children: [view === "form" && /*#__PURE__*/_jsxDEV("div", {
        style: {
          flex: 1,
          overflow: "hidden",
          display: "flex",
        ...
        children: [step === 0 && /*#__PURE__*/_jsxDEV(SessionView, {
          devList: devList,
          inspList: inspList,
          records: records,
        ...
        }, void 0, false), step >= 1 && /*#__PURE__*/_jsxDEV(_Fragment, {
          children: [/*#__PURE__*/_jsxDEV("div", {
            style: {
              display: "flex",
              alignItems: "center",
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                children: [/*#__PURE__*/_jsxDEV("div", {
                  style: {
                    ...
                    boxShadow: step === s.n ? "0 2px 8px rgba(37,99,176,0.4)" : "none"
                  },
                  children: step > s.n ? "✓" : s.n + 1
                }, void 0, false), /*#__PURE__*/_jsxDEV("span", {
                  style: {
                    fontWeight: 700,
                    fontSize: 13,
          ...
          children: filteredRows.length === 0 ? /*#__PURE__*/_jsxDEV("div", {
            ...
            children: [/*#__PURE__*/_jsxDEV("thead", {
              children: /*#__PURE__*/_jsxDEV("tr", {
                ...
                children: [[...(devVisibleCols.length > 0 ? devVisibleCols : ["階", "部屋名", "管理番号", "機器番号"]), "状態", "点検日", "点検者", "運転", "モード", "設定温度"].map(h => {
                  ...
                  return /*#__PURE__*/_jsxDEV("th", {
                    ...
                    children: [h.length > 4 ? /*#__PURE__*/_jsxDEV(_Fragment, {
                      children: [h.slice(0, Math.ceil(h.length / 2)), /*#__PURE__*/_jsxDEV("br", {}, void 0, false), h.slice(Math.ceil(h.length / 2))]
                    }, void 0, true) : h, isSort ? sortDir === "asc" ? " ▲" : " ▼" : ""]
                  }, h, true);
              ...
              children: filteredRows.map((row, i) => {
                ...
                return /*#__PURE__*/_jsxDEV("tr", {
                  ...
                  children: [(devVisibleCols.length > 0 ? devVisibleCols : ["階", "部屋名", "管理番号", "機器番号"]).map((col, j) => {
                    ...
                    children: hasMeasure ? /*#__PURE__*/_jsxDEV("div", {
                      ...
                      onClick: () => {
                        ...
                        // 行の建物・階をsessionInfoのtargetFloorsに反映
                        const bKey = devColumns.find(k => /建物|building|棟|ビル/i.test(k));
        ...
        }, void 0, false), modalSec && /*#__PURE__*/_jsxDEV("div", {
          style: {
            position: "fixed",
            inset: 0,
          ...
          children: /*#__PURE__*/_jsxDEV("div", {
            ...
            children: [(() => {
              ...
              children: [{
                ...
                id
              }) => modalSec === id && /*#__PURE__*/_jsxDEV("div", {
                children: [id === "device" && /*#__PURE__*/_jsxDEV("div", {
                  ...
                  }, void 0, true), devList.length > 0 && /*#__PURE__*/_jsxDEV("div", {
                    children: [/*#__PURE__*/_jsxDEV("div", {
                      style: {
                        fontSize: 11,
                        fontWeight: 700,
                      ...
                      children: /*#__PURE__*/_jsxDEV("table", {
                        ...
                        children: [/*#__PURE__*/_jsxDEV("thead", {
                          children: /*#__PURE__*/_jsxDEV("tr", {
                            children: (devVisibleCols.length > 0 ? devVisibleCols : devColumns).map(h => /*#__PURE__*/_jsxDEV("th", {
                              style: {
                                background: C.g100,
                                padding: "6px 8px",
                                textAlign: "center",
                          ...
                          children: [devList.slice(0, 5).map((d, i) => {
                          ...
                          }), devList.length > 5 && /*#__PURE__*/_jsxDEV("tr", {
                            children: /*#__PURE__*/_jsxDEV("td", {
                ...
                }, void 0, true), id === "cols" && /*#__PURE__*/_jsxDEV("div", {
                  children: devColumns.length === 0 ? /*#__PURE__*/_jsxDEV("div", {
                    style: {
                      padding: "12px 16px",
                      background: "#FFF7ED",
                      borderRadius: 8,
                    ...
                    children: "⚠️ 先に機器リストCSVを読み込んでください。読み込み後に列が自動抽出されます。"
                    ...
                    children: [/*#__PURE__*/_jsxDEV("p", {
                      ...
                      children: ["チェックした列を「入室可否チェック」と「機器選択リスト」に表示します。", /*#__PURE__*/_jsxDEV("br", {}, void 0, false), "※ 「本日の対象エリア」の階ボタンには影響しません。"]
                    }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
                      style: {
                        display: "flex",
                        gap: 6,
                      ...
                      children: devColumns.map(col => {
                        ...
                        return /*#__PURE__*/_jsxDEV("label", {
                          ...
                          children: [/*#__PURE__*/_jsxDEV("input", {
                            ...
                            children: [devList.filter(d => d._raw && d._raw[col]).length, "件に値あり"]
                          }, void 0, true)]
                        }, col, true);
                      })
                    }, void 0, false)]
                  }, void 0, true)
                }, void 0, false), id === "inspector" && /*#__PURE__*/_jsxDEV("div", {
                  children: [/*#__PURE__*/_jsxDEV("p", {
                    style: {
                      fontSize: 13,
                      color: C.g500,
